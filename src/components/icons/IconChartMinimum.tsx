const IconChartMinimum = ({ height = 20, width = 20 }) => {
	return (
		<svg height={height} width={width} viewBox="0 0 32 32" class="fill-current">
			<path d="M4,28V26H6V24H4V2H2V28a2,2,0,0,0,2,2H30V28Z" />
			<path d="M8 24H10V26H8zM12 24H14V26H12zM20 24H22V26H20zM24 24H26V26H24zM28 24H30V26H28z" />
...
export default IconChartMinimum;
