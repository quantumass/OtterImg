const IconDataConnected = ({ height = 20, width = 20 }) => {
	return (
		<svg height={height} width={width} viewBox="0 0 32 32" class="fill-current">
			<path d="M30 30L24 30 24 28 28 28 28 4 24 4 24 2 30 2 30 30z" />
			...
			<path d="M8 30L2 30 2 2 8 2 8 4 4 4 4 28 8 28 8 30z" />
		</svg>
	);
};
export default IconDataConnected;
