const IconEarthSoutheastAsiaFilled = ({ height = 20, width = 20 }) => {
	return (
		<svg height={height} width={width} viewBox="0 0 32 32" class="fill-current">
			<path d="M17 22H19V24H17zM17 18H19V20H17zM14 24H17V26H14z" />
...
export default IconEarthSoutheastAsiaFilled;
