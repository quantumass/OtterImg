const IconGameWireless = ({ height = 20, width = 20 }) => {
	return (
		<svg height={height} width={width} viewBox="0 0 32 32" class="fill-current">
			...
			<path d="M10,20a2,2,0,1,1,2-2A2,2,0,0,1,10,20Zm0-2Z" />
			<circle cx="22" cy="16" r="1" />
			<circle cx="22" cy="20" r="1" />
			<circle cx="20" cy="18" r="1" />
			<circle cx="24" cy="18" r="1" />
			<path d="M13.75,9l-1.5-1.33a5,5,0,0,1,7.5,0L18.25,9a3,3,0,0,0-4.5,0Z" />
			<path d="M21.25,6.37a7,7,0,0,0-10.5,0L9.25,5.05a9,9,0,0,1,13.5,0Z" />
		</svg>
	);
};
export default IconGameWireless;
