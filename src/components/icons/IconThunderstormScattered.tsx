const IconThunderstormScattered = ({ height = 20, width = 20 }) => {
	return (
		<svg height={height} width={width} viewBox="0 0 32 32" class="fill-current">
			<path d="M13.338 30L11.602 29 13.889 25 10 25 13.993 18 15.73 19 13.446 23 17.337 23 13.338 30z" />
			...
			<path d="M26.732 16.233H29.732V18.233H26.732z" transform="rotate(-135 28.232 17.233)" />
			<path d="M29 10H32V12H29z" />
			<path d="M26.732 3.768H29.732V5.768H26.732z" transform="rotate(-45 28.232 4.768)" />
			<path d="M20 0H22V3H20z" />
			<path d="M12.268 3.768H15.268V5.768H12.268z" transform="rotate(-135 13.768 4.768)" />
		</svg>
	);
};
export default IconThunderstormScattered;
