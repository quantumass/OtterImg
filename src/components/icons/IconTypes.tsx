const IconTypes = ({ height = 20, width = 20 }) => {
	return (
		<svg height={height} width={width} viewBox="0 0 32 32" class="fill-current">
			<path d="M30 16L22 24 20.586 22.586 27.172 16 20.586 9.414 22 8 30 16z" />
			...
			<path d="M2 16L10 8 11.414 9.414 4.828 16 11.414 22.586 10 24 2 16z" />
		</svg>
	);
};
